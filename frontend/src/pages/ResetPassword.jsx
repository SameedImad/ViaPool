...
function PasswordStrength({ password }) {
  ...
  return (
    <div style={{ marginTop: 8 }}>
      ...
      <div style={{ fontSize: "0.75rem", color: colors[score], marginTop: 4, fontWeight: 600 }}>
        {labels[score]}
      </div>
    </div>
  );
        ...
        <div className="auth-left">
          ...
          <div className="auth-form-wrap" style={{ textAlign: "center" }}>
            ...
            <Link to="/forgot-password" style={{ display: "inline-block", marginTop: 24 }}>
              <button className="auth-submit" style={{ width: "auto", padding: "14px 32px" }}>Request new link →</button>
            </Link>
          </div>
        </div>
          ...
          {!done ? (
            <>
              ...
              <form className="auth-form" onSubmit={handleSubmit} noValidate>
                ...
                <button className="auth-submit" type="submit" disabled={loading}>
                  {loading ? <><span className="auth-spinner" />Resetting…</> : "Set new password →"}
                </button>
              </form>
            </>
          ) : (
            ...
            <div style={{ textAlign: "center", paddingTop: 24 }}>
              <div style={{
                ...
                background: "rgba(45,74,53,0.1)", border: "2px solid var(--forest)",
      ...
      <div className="auth-right">
        ...
        <div className="auth-right-content">
          ...
          <div style={{ marginTop: 36, display: "flex", flexDirection: "column", gap: 14 }}>
            {[
              { icon: "🔡", t: "At least 8 characters",    d: "Longer passwords are harder to crack" },
              { icon: "🔢", t: "Mix letters and numbers",   d: "Combine uppercase, lowercase, and digits" },
              { icon: "✨", t: "Add a special character",   d: "!, @, #, $ etc. make it even stronger" },
            ].map(item => (
