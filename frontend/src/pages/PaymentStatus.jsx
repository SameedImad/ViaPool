  ...
  return (
    <AppShell title={success ? "Booking Confirmed" : "Payment Failed"} role="passenger" unreadCount={2}>
      <div className="status-card">
        {success ? (
          <>
            <div className="status-icon success">Confirmed</div>
          ...
          <>
            ...
            <div className="status-sub">
              Something went wrong with your payment. Your booking has not been confirmed. No money has been deducted.
            </div>
          ...
          <>
            ...
            >
              ...
              {[
                ...
                { label: "Ride fare", val: `Rs.${RECEIPT.subtotal}` },
              ].map((r) => (
              ...
              >
                ...
                <span style={{ fontFamily: "var(--font-serif)", fontSize: "1.2rem", color: "var(--ink)" }}>
                  Rs.{RECEIPT.total}
                </span>
              </div>
            </div>
